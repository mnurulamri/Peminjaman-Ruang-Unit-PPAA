...
if (isset($this->session->userdata['logged_in'])) {
  header("location: http://ppf.fisip.ui.ac.id/backend/ppaa/ruang");
}
?>
<head>
...
<div class="container">
	<div id="login-box">
		<div class="logo">
			<img src="http://ppf.fisip.ui.ac.id/backend/assets/images/UI_logo.png" class="img img-responsive img-circle center-block"/>
		...
		<div class="controls">
            <?php echo form_open('ppaa/ldapLogin/koneksi'); ?>
            <?php
